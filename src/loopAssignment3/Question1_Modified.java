	...
	public static void main(String[] args) {
		...
		for (int counter = 1; counter <= numCount; counter++) {
			...
			if (number % 2 == 0) {
				...
				//if number is even, it is stored in the array at corresponding index, other index will have default value zero
			} else {
				oddCounter += 1;
				oddNumList[i] = number;
				//if number is odd, it is stored in the array at corresponding index, other index will have default value zero
			}
		}
